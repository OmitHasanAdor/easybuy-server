...
const trendingProducts = [
  {
    ...
    price: 1450,
    description: "A crisp, breathable oxford shirt built for everyday wear.",
    category: "Men's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/01-classic-oxford-shirt-vton-optimized.jpg",
  ...
  },
  {
    ...
    images: [
      "/trial-room/live-backend-garments/vton-optimized/02-linen-summer-dress-vton-optimized.jpg",
  ...
  { name: "Ceramic Vase Set", price: 750, description: "Set of two handmade ceramic vases.", category: "Home & Lifestyle", images: ["https://images.unsplash.com/photo-1578500494198-246f612d3b3d?w=600"], stock: 20, isBestSeller: false },
  {
    ...
    price: 1350,
    description: "Comfortable stretch-cotton chinos for daily wear.",
    category: "Men's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/06-slim-fit-chinos-vton-optimized.jpg",
  ...
  },
  {
    ...
    price: 4200,
    description: "Warm, tailored overcoat for the cooler months.",
    category: "Men's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/07-wool-blend-overcoat-vton-optimized.png",
  ...
  },
  {
    ...
    price: 1850,
    description: "Elegant silk blouse with a flattering wrap fit.",
    category: "Women's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/08-silk-wrap-blouse-vton-optimized.jpg",
  ...
  },
  {
    ...
    price: 1600,
    description: "Classic high-waist jeans with a comfortable stretch fit.",
    category: "Women's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/09-high-waist-denim-jeans-vton-optimized.jpg",
  ...
  },
  {
    ...
    category: "Women's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/10-knit-cardigan-vton-optimized.jpg",
  ...
  // Curated apparel items for AI Virtual Trial Room
  {
    name: "Gingham Check Puff Sleeve Maxi Dress",
    price: 2450,
    description: "Romantic gingham check maxi dress with charming puff sleeves and a flared skirt.",
    category: "Women's Fashion",
    images: ["/trial-room/garments/dresses/gingham-check-puff-sleeve-maxi-dress.jpg"],
    stock: 14,
    isBestSeller: false,
  },
  {
    name: "Versace Neon Lime Draped Dress",
    price: 4950,
    description: "Dramatic neon lime draped party dress with structured shoulders.",
    category: "Women's Fashion",
    images: ["/trial-room/garments/dresses/versace-neon-lime-draped-dress.jpg"],
    stock: 8,
    isBestSeller: false,
  },
  {
    ...
    price: 1550,
    description: "Tailored cream chinos crafted from premium breathable cotton stretch twill.",
    category: "Men's Fashion",
    images: ["/trial-room/garments/lower-body/cream-slim-fit-chinos.jpg"],
    stock: 20,
    isBestSeller: false,
  },
  {
    name: "Paisley Silk Wide-Leg Trousers",
    price: 1950,
    description: "Breezy bohemian wide-leg trousers in an intricate vibrant paisley print.",
    category: "Women's Fashion",
    images: ["/trial-room/garments/lower-body/paisley-silk-wide-leg-trousers.jpg"],
    stock: 16,
    isBestSeller: false,
  },
  {
    name: "Stussy Script Logo Tee Black",
    price: 850,
    description: "Classic relaxed fit streetwear tee featuring iconic script chest branding.",
    category: "Men's Fashion",
    images: ["/trial-room/garments/upper-body/stussy-script-logo-tee-black.jpg"],
    stock: 35,
    isBestSeller: false,
  },
  {
    name: "Sage Green Suede Trucker Jacket",
    price: 3850,
    description: "Premium buttery-soft suede trucker jacket in contemporary sage green.",
    category: "Men's Fashion",
    images: ["/trial-room/garments/upper-body/sage-green-suede-trucker-jacket.png"],
    stock: 10,
    isBestSeller: false,
  },
  {
    name: "Pink Sweetheart Ribbed Crop Top",
    price: 950,
    description: "Ribbed knit crop top featuring a feminine sweetheart neckline.",
    category: "Women's Fashion",
    images: ["/trial-room/garments/upper-body/pink-sweetheart-ribbed-crop-top.png"],
    stock: 22,
    isBestSeller: false,
  },
];
...
const bestSellerProducts = [
  {
    ...
    price: 2650,
    description: "Premium merino wool crewneck, warm without the bulk.",
    category: "Men's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/41-merino-wool-sweater-vton-optimized.jpg",
  ...
  { name: "Minimal Gold Necklace", price: 1350, description: "Delicate gold-plated chain necklace for everyday layering.", category: "Women's Fashion", images: ["https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=600"], stock: 23, isBestSeller: true },
  {
    ...
    price: 1250,
    description: "Breathable linen shirt with a relaxed everyday fit.",
    category: "Men's Fashion",
    images: [
      "/trial-room/live-backend-garments/vton-optimized/46-linen-casual-shirt-vton-optimized.jpg",
